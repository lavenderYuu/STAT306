...
![](images/ResidualBeforeTransformation.jpg)
...
| Model   | Explanatory Variables      | P-value  |
|---------|----------------------------|----------|
| Model 1 | (Intercept)                | 0.5192   |
|         | DailyCaloricSurplusDeficit | 0.0117   |
|         | SleepQuality               | 2.16e-15 |
|         | StressLevel                | 1.42e-08 |
|         | Age                        | 0.4917   |
|         | GenderF                    | 0.2693   |
|         | CurrentWeightLbs           | 0.5321   |
|         | PhysicalActivityLevel      | 0.7698   |
| Model 2 | (Intercept)                | 0.3357   |
|         | DailyCaloricSurplusDeficit | 0.00113  |
|         | SleepQuality               | 4.64e-16 |
|         | StressLevel                | 7.19e-09 |
|         | Age                        | 0.4775   |
|         | GenderF                    | 0.2716   |
|         | CurrentWeightLbs           | 0.5562   |
| Model 3 | (Intercept)                | 0.01778  |
|         | DailyCaloricSurplusDeficit | 0.00125  |
|         | SleepQuality               | 3.69e-16 |
|         | StressLevel                | 5.66e-09 |
|         | Age                        | 0.47514  |
|         | GenderF                    | 0.32874  |
| Model 4 | (Intercept)                | 0.01913  |
|         | DailyCaloricSurplusDeficit | 0.00139  |
|         | SleepQuality               | 2.58e-16 |
|         | StressLevel                | 4.45e-09 |
|         | GenderF                    | 0.34555  |
| Model 5 | (Intercept)                | 0.00659  |
|         | DailyCaloricSurplusDeficit | 0.00185  |
|         | SleepQuality               | 2.78e-16 |
|         | StressLevel                | 5.27e-09 |

The most important predictors of **expWeightCPW** (expected weight change) are **DailyCaloricSurplusDeficit**, **SleepQuality**, and **StressLevel** across all models. These variables have consistently low p-values, indicating they are statistically significant. On the other hand, variables such as **Age**, **GenderF**, and **CurrentWeightLbs** do not show a significant relationship with weight change in most models. The simpler models (e.g., Model 5) suggest that we can adequately predict weight change using just these three key variables, which could help simplify future predictive models without significant loss of explanatory power.
...
-   **QQ Plot**: The QQ plot confirmed the residuals followed a normal distribution, supporting the validity of the model.
    ...
    ### ![]()![](images/QQ%20plot.jpg)**Model Refinement**
    ...
    -   **Interaction Effects**:\
        ...
        ![](images/interation%2001.jpg)

        ![](images/WechatIMG516.jpg)

        ![](images/interaction%2003.jpg)**Quadratic Relationships**:\
    ...
    ![](images/quadratic%2001.jpg)

    ![](images/quadratic%2002.jpg)

    ![](images/quadratic%2003.jpg)

-   **Model Refinement with Statistically Significant Predictors**

    During the model refinement process, we tested the significance of the predictors through stepwise elimination, focusing on retaining only those variables with a statistically significant contribution to the model. This process involved analyzing the **p-values** of each predictor in the regression analysis.
