...
-   **Boxplot:** The boxplot shows weekly weight change (**expWeightCPW**) across physical activity levels (Sedentary, Lightly Active, Moderately Active, Very Active). Higher activity levels correlate with greater weight change, with the **Very Active** group showing the highest median and widest variability (larger interquartile range and longer whiskers). The **Sedentary** group has the lowest median change. No significant outliers are present, suggesting consistent data. This trend indicates a positive link between activity level and weight change, though statistical tests are needed for confirmation.![](images/boxplot.jpg){width="305"}
...
![](images/ResidualBeforeTransformation.jpg){width="266"}

![](images/histogram.jpg){width="264"}
...
Linearity: The relationship between the independent variables chosen and weight change is linear

Independence: The dataset comprises data from 100 participants, and it is assumed that each participant's data represents an independent observation.

Homoscedasticity: The residual plot indicates a random scatter of points around zero, suggesting that the assumption of homoscedasticity is satisfied.
